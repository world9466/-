...
try:
    ...
    audience_fifty = int(len(AudienceName)*0.5)   #前50%觀眾會被納入辭庫中
    ...
    wc = WordCloud(background_color = 'white', min_font_size = 12,   
                   scale = 9, width=800, height=400,
    ...
    with open('separate/NLP.html', 'w', encoding='utf8') as rw:
        ...
        rw.write('</div>')
        cloud_img = ('<br>'+'<img src="../NLP/NLP-Cloud.png" width="70% alt="Cloud">')
        rw.write(cloud_img)
