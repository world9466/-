...
'<span style="color:#000000;font-weight:bold;margin-left:40px;"><a href="http://10.227.58.87/night-news/history/{}/">前一天</a></span>'.format(yesterday)+
'<span style="color:#000000;font-weight:bold;margin-left:30px;"><a href="http://10.227.58.87/night-news/">晚報最新</a></span>'+
...
'<span style="color:#000000;font-weight:bold;margin-left:40px;"><a href="http://10.227.58.87/night-news/history/{}/">前一天</a></span>'.format(yesterday)+
'<span style="color:#000000;font-weight:bold;margin-left:40px;"><a href="http://10.227.58.87/night-news/history/{}/">後一天</a></span>'.format(tomorrow)+
'<span style="color:#000000;font-weight:bold;margin-left:40px;"><a href="http://10.227.58.87/night-news/">晚報最新</a></span>'+
'<span style="color:#000000;font-weight:bold;margin-left:30px;"><a href="http://10.227.58.87/">主頁</a></span>'+
'</div>'
)
...
rw_backup = open('../../晨午晚報_資料/history/night/晚報 - {}.html'.format(time_now),'w',encoding = 'utf8')
...
#w_backup.write(head+title+toggle_history+ytsubs_rank+yt24fast+ythot10+ytnews+ppt_hot_talk)
